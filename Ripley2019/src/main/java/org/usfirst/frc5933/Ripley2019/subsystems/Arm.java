...
public class Arm extends Subsystem {
	...
	public static double vBusDownMax = -0.7; // probably don’t want to lower at top speed. Should be a negative number.
	...
	*/
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        public void startEncoderPositioning(int desiredGoalPositioning) {
			...
			if (desiredGoalPositioning == rocketOne) {
				...
				SmartDashboard.putString("Encoder Position", "one one"); 
    ...
    public void periodic() {
		...
		SmartDashboard.putNumber("Bottom Encoder", bottomEncoder);
        //setArmFeedback(10);
		...
		if (encoderPositioningUnderway == true) {
			...
			if (e < 0) {  // don’t lower too quickly 
				vBus = e * kDown; 
				if (vBus < vBusDownMax) { 
					vBus = vBusDownMax; 
				} 
