...
public class DriveTrain extends Subsystem {
	...
	private static double tWConstant = 0.5; //Training wheels Constant
	...
	public void arcadeDrive() {
		...
		robotDrive.arcadeDrive(-Robot.oi.driverJoystick.getY()*tWConstant, Robot.oi.driverJoystick.getX()*tWConstant);
	}
	...
	public void trainingWheels(){
		tWConstant = 0.5; //setting the speed back to half power
	}

	public void speedup (){ //change the speed back up slowly to not frighten people
		//THE END GOAL: change the tWConstant to full power... 1.0
		//use an if statement to slowly gain speed... hopefully evert 20 milleseconds
		if(tWConstant < 1.0)
		{
			tWConstant = tWConstant + 0.005;
		}
		else
		{
			tWConstant = 1.0;
